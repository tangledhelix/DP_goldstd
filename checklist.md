...
* [ ] Find and fix any single-asterisk Proofer Comments: Search regex `\[\*[^*]`
...
* [ ] Use `File → Save a Copy As` to make `goldstd.html`
...
* [ ] Open `goldstd.html` that was saved previously.
...
* [ ] If {super,sub}scripts were used, convert to `<sup>` or `<sub>` (NOTE: does Guiguts do this itself? Seems to for subs.)
...
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID624c94ea72f43), select SR time period, upload `goldstd-sr.zip`
...
* [ ] Add **anonymized** files to git, e.g. `goldstd-smoothread01.txt`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID624c94ea72f43))
